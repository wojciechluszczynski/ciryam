...
const translations: Record<Lang, Record<string, string>> = {
  pl: {
    ...
    "stats.concerts": "Koncertów (łącznie z eventami)",
    ...
    "concerts.archive.note": "Około 400 koncertów za nami, daty 250 wciąż w pamięci – reszta to już rock'n'rollowa legenda.",
    ...
    "concerts.page.desc1": "Każdy koncert CIRYAM to niepowtarzalne przeżycie – od małych, kameralnych klubów po wielkie festiwalowe sceny. Sprawdź najbliższe daty i zobacz, gdzie zagramy.",
    ...
    "concerts.seo.p2": "Jeśli szukasz polskiego zespołu rockowego na festiwal, event firmowy lub imprezę prywatną – skontaktuj się z nami przez zakładkę Kontakt.",
    ...
    "press.rider.note": "* Pełny rider techniczny do pobrania poniżej. Kontakt: okoartmanagement@gmail.com / +48 605 103 072 (Robert Węgrzyn). Wizualizacje: Kuba Czubik / +48 693 223 230.",
    "press.rider.download": "Pobierz pełny rider (PDF)",
  ...
  en: {
    ...
    "stats.albums": "Albums",
    "stats.concerts": "Concerts (incl. events)",
    ...
    "concerts.empty.facebook": "Facebook",
    "concerts.archive.note": "Around 400 shows behind us, the first 250 still etched in memory – the rest is already rock'n'roll legend.",
    ...
    "concerts.page.desc1": "Every CIRYAM concert is a unique experience – from intimate club shows to big festival stages. Check upcoming dates and see where we play next.",
    ...
    "concerts.seo.p2": "If you're looking for a Polish rock band for a festival, corporate event or private party – contact us through the Contact page.",
    ...
    "about.page.p4": "CIRYAM works on every stage - festivals, clubs, corporate and private events. Line-up: Monika Węgrzyn (vocals), Robert Węgrzyn (guitars, leader), Kuba Czubik (lead guitar), Jacek Rola (bass). Drums – samples / sequencer (in-ear, laptop).",
    ...
    "press.bio.p2": "Our discography includes five studio albums, with the latest being „Zamyślony zapach\". CIRYAM works on every stage - festivals, clubs, corporate and private events. Line-up: Monika Węgrzyn (vocals), Robert Węgrzyn (guitars, leader), Kuba Czubik (lead guitar), Jacek Rola (bass). Drums – samples / sequencer (in-ear, laptop).",
    "press.bio.founded": "Founded",
    "press.bio.albums": "Albums",
    "press.bio.concertsYear": "Concerts/year",
    "press.bio.totalConcerts": "Total shows (incl. events)",
    ...
    "press.rider.intro": "CIRYAM uses its own in-ear monitoring system. Below is a short version of the technical requirements. The full rider is available as a PDF.",
    "press.rider.stage": "Stage",
    "press.rider.stageVal": "Min. 5×4 m, covered for outdoor concerts",
    "press.rider.pa": "PA System",
    "press.rider.paVal": "System with even frequency response, 115 dB SPL C at the FOH position, 40 Hz – 16 kHz, distortion-free. Calibrated before the band arrives.",
    "press.rider.monitors": "Monitors",
    "press.rider.monitorsVal": "The band brings its own in-ear monitoring system.",
    "press.rider.lights": "Lighting",
    "press.rider.lightsVal": "LED screen mounted centrally at the back of the stage (HDMI). The band brings its own computer for visuals.",
    "press.rider.backline": "Backline",
    "press.rider.backlineVal": "Lead vocal (own mic), vocal + guitar Robert (SM58/Beta58), guitar Kuba (D.I), guitar Robert (D.I), bass Jacek (D.I), Soundcraft Main L+R (D.I)",
    "press.rider.channels": "Mixer channels",
    "press.rider.channelsVal": "Visuals are used during the show. The band brings its own equipment (laptop, mixer). A technician is required to adjust screen brightness.",
    "press.rider.note": "* Full technical rider available below. Contact: okoartmanagement@gmail.com / +48 605 103 072 (Robert Węgrzyn). Visuals: Kuba Czubik / +48 693 223 230.",
    "press.rider.download": "Download full rider (PDF)",
